...
export default () => {
  ...
  const ClockInOut = lazy(() => import("./views/clock-in-out/clock-in-out.view").catch(() => ({ default: FailedToLoad })));
  const CheckInsOuts = lazy(() => import("./views/clock-in-out/check-ins-outs.view").catch(() => ({ default: FailedToLoad })));
