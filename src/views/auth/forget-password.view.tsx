...
export default () => {
  // State variables for step and email
    ...
    <div className="w-full px-6 md:px-0 mb-10 lg:flex lg:justify-center lg:gap-60 lg:items-center lg:mt-5">
      <div className="lg:w-5/12">
        <div className='flex items-center justify-center'>
          <img className='h-[200px] w-[200px] text-center' src={trackterra} alt="Trackterra" />
        </div>
        {/* Render SendCode component if step is 1 */}
        {step === 1 && <SendCode setStep={setStep} email={email} setEmail={setEmail} />}
        {/* Render NewPassword component if step is 2 */}
